	  ...
	  <nav class="mt-2">
		<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  <!-- Add icons to the links using the .nav-icon class
			...
			<li class="nav-item ">
                <a href="{{ route('pelanggan.index') }}" class="nav-link {{ Route::currentRouteName() == 'pelanggan.index' ?  'active' : '' }}">
			...
			<li class="nav-item ">
                <a href="{{ route('penjualan.index') }}" class="nav-link {{ Route::currentRouteName() == 'penjualan.index' ?  'active' : '' }}">
			...
			<li class="nav-item">
				<a href="{{ route('servers.index') }}" class="nav-link {{ Route::currentRouteName() == 'servers.index' ?  'active' : '' }}">
			...
			<li class="nav-item ">
                <a href="{{ route('token.index') }}" class="nav-link {{ Route::currentRouteName() == 'token.index' ?  'active' : '' }}">
                    <i class="nav-icon fas fa-key"></i>
                    <p>App Token</p>
                </a>
            </li>
			<li class="nav-item">
				<a href="{{route('home.log')}}" class="nav-link {{ Route::currentRouteName() == 'home.log' ?  'active' : '' }}">
					<i class="nav-icon fas fa-book"></i>
					<p>Logs</p>
				</a>
			</li>
			<li class="nav-item">
				<a href="{{ route('home.system') }}" class="nav-link {{ Route::currentRouteName() == 'home.system' ?  'active' : '' }}">
