...
@section('pagetitle', 'Daftar Pelanggan')
        ...
        <div class="card">
            ...
            <div class="card-footer">
                <div class="float-right">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#modal-new" id="create">Input Pelanggan</button>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Input Pelanggan</h4>
                            ...
                            <form id="1stform" action="">
                                <div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="id_pelanggan" value="" placeholder="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="domisili" value="" placeholder="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="jenis_kelamin" value="" placeholder="" required>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <form id="2ndform" action="">
                                <div>
                                    ...
                                    <div class="form-group row">
                                        <label for="id_pelanggan" class="col-sm-4 col-form-label">ID Pelanggan</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="id_pelanggan" value="" placeholder="" required disabled>
                                        </div>
                                    </div>
...
@push('js')
    ...
    <script>
        $( document ).ready(function(){
            $("#1stform").submit(function(e){
                ...
                crudAjax(
                    ...
                    function(){
                        ...
                        toastr.success("Data pelanggan telah diinput!");
                        $("#1stform")[0].reset();
                        reload1stTable();
                    }
                );
            ...
            $('#formdestroy').submit(function(e){
                ...
                crudAjax(
                    ...
                    false,
                    function(){
                        toastr.success("Data pelanggan dihapus!");
                        reload1stTable();
                    }
                );
            });
            ...
            $(document).on('click', 'button.edit',function(e){
                ...
                $.ajax({
                    ...
                    success : function(data){
                        ...
                        var custroute = '{{route('pelanggan.update',':id')}}';
            ...
            $(document).on('click', 'button.destroy',function(e){
                e.preventDefault()
                if(confirm("Data pelanggan akan dihapus. Lanjutkan?")){
        ...
        function reload1stTable(){
            reloadTable(
                '1sttable',
                '{{ route('pelanggan.table.index') }}',
                '{{ route('pelanggan.edit', ':id') }}',
